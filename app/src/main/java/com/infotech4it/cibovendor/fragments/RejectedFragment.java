...
import com.infotech4it.cibovendor.databinding.FragmentRejectedBinding;
...
public class RejectedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_rejected, container, false);
        init();
